...
define('css!jquery/adipoli/style',[],function(){});
/*
...
define("jquery/adipoli", ["jquery","css!jquery/adipoli/style"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.jQuery.fn.adipoli;
    };
}(this)));

define('css!jquery/fancybox/style',[],function(){});
/*!
...
define("jquery/fancybox", ["jquery","css!jquery/fancybox/style"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.jQuery.fn.fancybox;
    };
}(this)));
  ...
  define('data',{
    profile: {
      about: {
        ...
        Company: 'Social Ark Oy',
        Description: 'Young, wild and free!',
        img: 'avatar.jpg'
      },
      vcard: {
        Name: 'TruongSinh Tran-Nguyen',
        Email: 'i@truongsinh.pro',
        Phone: '+358-40-443-3223',
        Website: 'http://truongsinh.pro'
      }
    }
  });
...
define('rdust',['dust'], function(dust) {
...
define('rdust!page/profile/template',['dust'],function(dust){(function(){dust.register("page/profile/template",body_0);function body_0(chk,ctx){return chk.write("<!-- About section --><div class=\"about\"><div class=\"photo-inner\"><img src=\"").reference(ctx.getPath(false,["about","img"]),ctx,"h").write("\" height=\"186\" width=\"153\" /></div><h1>").reference(ctx.getPath(false,["vcard","Name"]),ctx,"h").write("</h1><h3>").reference(ctx.getPath(false,["about","Title"]),ctx,"h").write("</h3><p>").reference(ctx.getPath(false,["about","Description"]),ctx,"h").write("</p></div><!-- /About section --><!-- Personal info section --><ul class=\"personal-info\">").section(ctx.get("vcard"),ctx,{"block":body_1},null).write("</ul><!-- /Personal info section -->");}function body_1(chk,ctx){return chk.write("<li><label>Name</label><span>").reference(ctx.get("Name"),ctx,"h").write("</span></li><li><label>Email</label><span>").reference(ctx.get("Email"),ctx,"h").write("</span></li><li><label>Phone</label><span>").reference(ctx.get("Phone"),ctx,"h").write("</span></li><li><label>Website</label><span>").reference(ctx.get("Website"),ctx,"h").write("</span></li>");}return body_0;})(); return function(context, callback) {return dust.render('page/profile/template', context, callback)}});
// Generated by CoffeeScript 1.3.3
(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  define('page/base',['require','backbone'],function(require) {
    var B, View;
    B = require('backbone');
    return View = (function(_super) {
      ...
      View.prototype.render = function() {
        var _this = this;
        this.template(this.model, function(err, res) {
          if (err) {
            throw err;
          }
          return _this.$el.html(res);
        });
        return this;
      };
...
(function() {
  ...
  define('page/profile/main',['require','data','rdust!./template','../base'],function(require) {
    var Base, View, data, template;
    data = require('data');
    ...
    return View = (function(_super) {
      ...
      View.prototype.id = 'profile';

      View.prototype.model = data.profile;
...
define('rdust!page/template',['dust'],function(dust){(function(){dust.register("page/template",body_0);function body_0(chk,ctx){return chk.write("<div style='text-align: center'><img src='under_construction.jpg'></div>");}return body_0;})(); return function(context, callback) {return dust.render('page/template', context, callback)}});
// Generated by CoffeeScript 1.3.3
(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  define('page/portfolio/main',['require','rdust!../template','../base'],function(require) {
    var Base, View, template;
    template = require('rdust!../template');
    Base = require('../base');
    return View = (function(_super) {
...
(function() {
  ...
  define('page/resume/main',['require','rdust!../template','../base'],function(require) {
    var Base, View, template;
    template = require('rdust!../template');
    Base = require('../base');
    return View = (function(_super) {
...
(function() {
  ...
  define('page/contact/main',['require','rdust!../template','../base'],function(require) {
    var Base, View, template;
    template = require('rdust!../template');
    Base = require('../base');
    return View = (function(_super) {
...
(function() {
  ...
  define('main',['require','jquery','jquery/isotope','jquery/adipoli','jquery/fancybox','backbone','page/profile/main','page/portfolio/main','page/resume/main','page/contact/main'],function(require) {
    var $, $contactform, $container, $content, $filter, $logo, $success, B, Router, page;
    $ = require('jquery');
    ...
    */
    ...
    $contactform.submit(function() {
      $.ajax({
        ...
        success: function(msg) {
          ...
          return $contactform.prepend(response);
        }
      });
      return false;
    });
    $('.bg-switcher').click(function() {
      ...
      return $('body').css('background-image', 'url(images/bg' + bgNumber + '.png)');
    });
    Router = B.Router.extend({
      ...
      initialize: function() {
        return $('#content > div').hide(0).promise().done(function() {
          $('body').show();
          return B.history.start();
        });
      },
      changePage: function(page, subpage) {
        var show,
          _this = this;
        ...
        show = function() {
          _this.activePage = _this.pageMap[page];
          return _this.activePage.stop().slideDown(_this.transitionDuration);
        };
        if (this.activePage) {
          return this.activePage.stop().slideUp(this.transitionDuration, show);
        } else {
          return show();
        }
      }
...
css.inject('.adipoli-wrapper\n{\n    margin:auto;\n    position:relative;\n    display: inline-block;\n}\n.adipoli-wrapper>img\n{\n    position: absolute;\n    z-index: 1;\n}\n.adipoli-before\n{\n    position: absolute;\n    z-index: 5;\n}\n.adipoli-after\n{\n    position: absolute;\n    z-index: 10;\n}\n.adipoli-slice {\n    display:block;\n    position:absolute;\n    z-index:15;\n    height:100%;\n}\n.adipoli-box\n{\n    display:block;\n    position:absolute;\n    z-index:15;\n}/*! fancyBox v2.1.3 fancyapps.com | fancyapps.com/fancybox/#license */\n.fancybox-wrap,\n.fancybox-skin,\n.fancybox-outer,\n.fancybox-inner,\n.fancybox-image,\n.fancybox-wrap iframe,\n.fancybox-wrap object,\n.fancybox-nav,\n.fancybox-nav span,\n.fancybox-tmp\n{\n\tpadding: 0;\n\tmargin: 0;\n\tborder: 0;\n\toutline: none;\n\tvertical-align: top;\n}\n\n.fancybox-wrap {\n\tposition: absolute;\n\ttop: 0;\n\tleft: 0;\n\tz-index: 8020;\n}\n\n.fancybox-skin {\n\tposition: relative;\n\tbackground: #f9f9f9;\n\tcolor: #444;\n\ttext-shadow: none;\n\t-webkit-border-radius: 4px;\n\t   -moz-border-radius: 4px;\n\t        border-radius: 4px;\n}\n\n.fancybox-opened {\n\tz-index: 8030;\n}\n\n.fancybox-opened .fancybox-skin {\n\t-webkit-box-shadow: 0 10px 25px rgba(0, 0, 0, 0.5);\n\t   -moz-box-shadow: 0 10px 25px rgba(0, 0, 0, 0.5);\n\t        box-shadow: 0 10px 25px rgba(0, 0, 0, 0.5);\n}\n\n.fancybox-outer, .fancybox-inner {\n\tposition: relative;\n}\n\n.fancybox-inner {\n\toverflow: hidden;\n}\n\n.fancybox-type-iframe .fancybox-inner {\n\t-webkit-overflow-scrolling: touch;\n}\n\n.fancybox-error {\n\tcolor: #444;\n\tfont: 14px/20px \"Helvetica Neue\",Helvetica,Arial,sans-serif;\n\tmargin: 0;\n\tpadding: 15px;\n\twhite-space: nowrap;\n}\n\n.fancybox-image, .fancybox-iframe {\n\tdisplay: block;\n\twidth: 100%;\n\theight: 100%;\n}\n\n.fancybox-image {\n\tmax-width: 100%;\n\tmax-height: 100%;\n}\n\n#fancybox-loading, .fancybox-close, .fancybox-prev span, .fancybox-next span {\n\tbackground-image: url(\'lib/jquery/fancybox/fancybox_sprite.png\');\n}\n\n#fancybox-loading {\n\tposition: fixed;\n\ttop: 50%;\n\tleft: 50%;\n\tmargin-top: -22px;\n\tmargin-left: -22px;\n\tbackground-position: 0 -108px;\n\topacity: 0.8;\n\tcursor: pointer;\n\tz-index: 8060;\n}\n\n#fancybox-loading div {\n\twidth: 44px;\n\theight: 44px;\n\tbackground: url(\'lib/jquery/fancybox/fancybox_loading.gif\') center center no-repeat;\n}\n\n.fancybox-close {\n\tposition: absolute;\n\ttop: -18px;\n\tright: -18px;\n\twidth: 36px;\n\theight: 36px;\n\tcursor: pointer;\n\tz-index: 8040;\n}\n\n.fancybox-nav {\n\tposition: absolute;\n\ttop: 0;\n\twidth: 40%;\n\theight: 100%;\n\tcursor: pointer;\n\ttext-decoration: none;\n\tbackground: transparent url(\'lib/jquery/fancybox/blank.gif\'); /* helps IE */\n\t-webkit-tap-highlight-color: rgba(0,0,0,0);\n\tz-index: 8040;\n}\n\n.fancybox-prev {\n\tleft: 0;\n}\n\n.fancybox-next {\n\tright: 0;\n}\n\n.fancybox-nav span {\n\tposition: absolute;\n\ttop: 50%;\n\twidth: 36px;\n\theight: 34px;\n\tmargin-top: -18px;\n\tcursor: pointer;\n\tz-index: 8040;\n\tvisibility: hidden;\n}\n\n.fancybox-prev span {\n\tleft: 10px;\n\tbackground-position: 0 -36px;\n}\n\n.fancybox-next span {\n\tright: 10px;\n\tbackground-position: 0 -72px;\n}\n\n.fancybox-nav:hover span {\n\tvisibility: visible;\n}\n\n.fancybox-tmp {\n\tposition: absolute;\n\ttop: -99999px;\n\tleft: -99999px;\n\tvisibility: hidden;\n\tmax-width: 99999px;\n\tmax-height: 99999px;\n\toverflow: visible !important;\n}\n\n/* Overlay helper */\n\n.fancybox-lock {\n\toverflow: hidden;\n}\n\n.fancybox-overlay {\n\tposition: absolute;\n\ttop: 0;\n\tleft: 0;\n\toverflow: hidden;\n\tdisplay: none;\n\tz-index: 8010;\n\tbackground: url(\'lib/jquery/fancybox/fancybox_overlay.png\');\n}\n\n.fancybox-overlay-fixed {\n\tposition: fixed;\n\tbottom: 0;\n\tright: 0;\n}\n\n.fancybox-lock .fancybox-overlay {\n\toverflow: auto;\n\toverflow-y: scroll;\n}\n\n/* Title helper */\n\n.fancybox-title {\n\tvisibility: hidden;\n\tfont: normal 13px/20px \"Helvetica Neue\",Helvetica,Arial,sans-serif;\n\tposition: relative;\n\ttext-shadow: none;\n\tz-index: 8050;\n}\n\n.fancybox-opened .fancybox-title {\n\tvisibility: visible;\n}\n\n.fancybox-title-float-wrap {\n\tposition: absolute;\n\tbottom: 0;\n\tright: 50%;\n\tmargin-bottom: -35px;\n\tz-index: 8050;\n\ttext-align: center;\n}\n\n.fancybox-title-float-wrap .child {\n\tdisplay: inline-block;\n\tmargin-right: -100%;\n\tpadding: 2px 20px;\n\tbackground: transparent; /* Fallback for web browsers that doesn\'t support RGBa */\n\tbackground: rgba(0, 0, 0, 0.8);\n\t-webkit-border-radius: 15px;\n\t   -moz-border-radius: 15px;\n\t        border-radius: 15px;\n\ttext-shadow: 0 1px 2px #222;\n\tcolor: #FFF;\n\tfont-weight: bold;\n\tline-height: 24px;\n\twhite-space: nowrap;\n}\n\n.fancybox-title-outside-wrap {\n\tposition: relative;\n\tmargin-top: 10px;\n\tcolor: #fff;\n}\n\n.fancybox-title-inside-wrap {\n\tpadding-top: 10px;\n}\n\n.fancybox-title-over-wrap {\n\tposition: absolute;\n\tbottom: 0;\n\tleft: 0;\n\tcolor: #fff;\n\tpadding: 10px;\n\tbackground: #000;\n\tbackground: rgba(0, 0, 0, .8);\n}'); 
}); 
